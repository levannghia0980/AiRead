...
async def extract_batch_entities_direct_llm(
    ...
    injected_text = inject_chapter_extraction_prompts(masked_text)

    # Nạp thông tin Profile Thể Loại đặc thù của truyện
    from app.services.translation.rawt.profiles import get_profile_description, normalize_profile_key
