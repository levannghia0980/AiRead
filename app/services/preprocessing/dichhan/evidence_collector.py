...
SYSTEM_PROMPT_INSTRUCTION = (
    ...
    "1. VAI TRÒ CỦA DỮ LIỆU GỢI Ý (SÀNG LỌC THÔNG MINH, KHÔNG TRẢ VỀ HẾT MÁY MÓC):\n"
    "   - Các trường gợi ý 'suggested_hanviet_example', 'db_example', 'gg_error' CHỈ LÀ THAM KHẢO THÔ BẬC THẤP.\n"
    "   - BẮT BUỘC phân tích vi ngữ cảnh 【...】 để chọn lọc: CHỈ giữ lại danh từ riêng, thực thể đích thực (tên người, địa danh, môn phái, võ công, pháp bảo).\n"
    "   - Nếu từ trong danh sách là từ thừa, từ ngữ đời thường nên dịch Việt, tiếng lóng, khẩu ngữ, hoặc cụm dính động từ/phó từ (như '叫...', '见...', '解这个...') ➔ BỎ QUA, TUYỆT ĐỐI KHÔNG trả về máy móc hết cả danh sách gửi lên.\n"
    "   - 🔴 CHỈ NHẬN DIỆN DANH TỪ RIÊNG THẬT SỰ (Tên người, Tên đất, Môn phái, Chiêu thức võ công):\n"
    "     * Tên nhân vật, nhũ danh: 潘子 (Phan Tử), 雷子 (Lôi Tử), 虎子 (Hổ Tử), 石头 (Thạch Đầu). \n"
