...
# Ngoại hiệu, đạo hiệu, danh xưng giang hồ, biệt hiệu hảo hán 2-4 chữ (Thủy Hử, Kiếm hiệp, Tiên hiệp)
EPITHET_SUFFIXES = (
    "金刚", "秀士", "天王", "太保", "二郎", "三郎", "忽律", "先锋", "和尚", "行者", 
    "阎罗", "太岁", "旋风", "神医", "道人", "真君", "仙子", "散人", "狂客", "剑客", 
    "剑仙", "剑圣", "刀客", "魔君", "鬼王", "龙王", "大王", "霸王",
    "居士", "掌门", "舵主", "星君", "判官", "无常", "煞神", "罗汉", "飞将", "神枪",
    "神手", "书生", "剑仙", "剑神", "剑宗", "刀狂", "拳王", "怪侠", "狂生"
)
