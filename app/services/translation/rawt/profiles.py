...
COMMON_RULES = (
    ...
    "2. VĂN PHONG & DỊCH ĐÚNG NGHĨA BÓNG / NGỮ CẢNH: Dịch hay, tự nhiên, dùng từ ngữ tiếng Việt phổ thông, dễ hiểu, phù hợp với thể loại truyện. BẮT BUỘC nhận diện đúng nghĩa bóng, hàm ý ẩn dụ của câu văn theo ngữ cảnh truyện (Ví dụ: khi nói mua chim về làm thú cưng/sủng vật để nuôi thì phải dịch là 'thú cưng/sủng vật', TUYỆT ĐỐI CẤM dịch nhầm thành 'nô tì thân cận/người hầu'). Giữ đúng bản chất chủ thể (không gán hành vi người cho con vật, đồ vật). Giữ nguyên thuật ngữ Hán-Việt quen thuộc (tu vi, đan điền, tán tu...), không ép thuần Việt hóa gượng gạo.\n"
